...
// $(document).ready(function() {
// 	var buttons = ['create', 'search', 'insert', 'remove'];
// 	var panels = [openCreate, openSearch, openInsert, openRemove];
  
// 	for (var i = 0; i < buttons.length; i++) {
// 	  attachClickHandler(buttons[i], panels[i]);
// 	}
  
// 	function attachClickHandler(buttonId, panelFunction) {
